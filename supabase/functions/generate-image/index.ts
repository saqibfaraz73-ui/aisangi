  ...
  try {
    ...
    const generateOne = async (index: number) => {
      ...
      const watermarkInstruction = watermarkEnabled
        ? `\n\nIMPORTANT: Add a subtle semi-transparent watermark text "SANGIAi" in the bottom-right corner of the image. The watermark should be visible but not distracting — use white text with ~40% opacity, slightly tilted, medium font size.`
        : "";
